...
@endphp
{{-- "Document Created" success card. Shared by the standalone created page and
     lifted into the New Submission modal after a successful fetch submit. --}}
<div data-created-card class="rounded-2xl border border-gray-200/90 bg-white p-8 text-center shadow-md">
